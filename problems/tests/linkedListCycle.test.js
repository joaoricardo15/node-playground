...
describe('hasCycle', () => {
    ...
    const list2 = new ListNode(randomNumber1, new ListNode(randomNumber2, new ListNode(randomNumber3)))
    test('should return false when input is an linked list without a cycle', () => {
        expect(hasCycle(list2)).toEqual(false)
    })

    const list3 = new ListNode(randomNumber1, new ListNode(randomNumber2, new ListNode(randomNumber3, new ListNode(randomNumber1))))
